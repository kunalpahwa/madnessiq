  ...
  EAST: {
    ...
    E8: [
      { id:"EE", date:"Sun Mar 29", time:"5:05 PM ET", site:"Capital One Arena, DC", s1:1, t1:"Duke", t1Short:"DUKE", s2:2, t2:"UConn", t2Short:"UCONN", pick:"Duke", confidence:55, riskLevel:"TOSS-UP",
        ...
        keyStats: [{ label: "Foster BACK", value: "11 pts off bench vs SJU", hot: true },{ label: "Evans S16", value: "25 pts, clutch step-back 3", hot: true },{ label: "UConn DNA", value: "Back-to-back champs 23-24", hot: true }],
        injuries: [{ player: "C. Foster", team: "Duke", status: "ACTIVE", impact: "HIGH", detail: "RETURNED vs SJU — 11 pts. Transforms Duke's perimeter creation." }],
        whyPick:"Foster's return changes everything. Duke was a different team with him on the floor vs SJU — settled the offense, created spacing, hit shots. Evans' 25-point explosion showed a second scorer emerging. Boozer had 13/9 after halftime when it mattered. Duke is 6-0 this season when trailing by 10+ — they don't break. UConn barely survived MSU 67-63 and hasn't looked dominant since the first weekend.",
        whyNot:"UConn has won two of the last three national titles. Dan Hurley's tournament adjustments are historically elite — he's never lost an NCAA tournament game he's been favored in. Reed Jr. dominated MSU inside and Boozer hasn't faced that kind of interior challenge. Karaban is a two-way monster. Duke went 12-20 from the free throw line vs SJU — if that continues against UConn's pressure, Duke loses. And UConn's defense held MSU to 63 despite Fears' clutch 3s." },
      ],
  },
  WEST: {
    R32: [
    ...
    E8: [
      { id:"WE", date:"Sat Mar 28", time:"8:49 PM ET", site:"SAP Center, San Jose", s1:1, t1:"Arizona", t1Short:"ARIZ", s2:2, t2:"Purdue", t2Short:"PUR", pick:"Arizona", confidence:70, riskLevel:"LEAN",
        headline:"FINAL: Arizona 79-64. Trailed 38-31 at half, then DOMINATED 48-26 in 2H. Peat 20. First F4 since 2001.",
        result: { score1:79, score2:64, winner:"Arizona", correct:true, postGame:"Arizona trailed 38-31 at halftime as Purdue hit 7 first-half threes and Smith started 3-4. Then Arizona flipped the switch — outscored Purdue 48-26 in the second half. Smith went 1-11 the rest of the way. Peat led with 20, Burries/Kharchenkov/Bradley all had 14+. Arizona held Purdue to 38% shooting. First Final Four since 2001. Tommy Lloyd emotional on the court." },
        market: { spread:"Arizona -6.5", ou:"152.5", ml1:"-280", ml2:"+230", take:"Arizona is the rightful favorite. They just had the most dominant offensive performance of the tournament. Purdue's interior defense ranks 334th in opponent 2PT% since January — and Arizona attacks inside at a 73.6% rate. The mismatch is structural.", angle:"ARIZONA -6.5 — Purdue's interior D can't handle AZ's paint attack. AZ covers." },
        edge: { offense: 95, defense: 92, experience: 80, health: 95 },
        edgeOpp: { offense: 88, defense: 55, experience: 90, health: 78 },
        keyStats: [{ label: "AZ S16", value: "109-88, 64% FG (!)", hot: true },{ label: "PUR 2PT D", value: "334th since Jan", hot: true },{ label: "TKR", value: "Buzzer tip-in to survive", hot: true }],
        injuries: [{ player: "CJ Cox", team: "Purdue", status: "QUESTIONABLE", impact: "HIGH", detail: "Non-contact knee injury vs Miami. Key 3PT shooter." }],
        whyPick:"Arizona just scored 109 in the Sweet 16 — the most dominant offensive performance of the tournament. Shot 64%, had six players score 14+, scored 46 paint points. Purdue's interior defense ranks 334th in opponent 2PT% since January. Arizona attacks inside at a 73.6% rate. That is a structural mismatch Purdue cannot fix in one day. Bradley and Burries are too quick for Smith and Loyer. Peat and Krivas will dominate the paint.",
        whyNot:"Purdue has championship-game experience from 2024. Smith just broke the NCAA career assists record. TKR has scored 19+ in four straight. Loyer has hit 4 threes in each tournament game — if he gets hot, Purdue can outscore anyone. And Purdue is 4-1 vs Arizona in the last five meetings. Tournament pedigree matters." },
      ],
  },
  SOUTH: {
    R32: [
    ...
    E8: [
      { id:"SE", date:"Sat Mar 28", time:"6:09 PM ET", site:"Toyota Center, Houston", s1:3, t1:"Illinois", t1Short:"ILL", s2:9, t2:"Iowa", t2Short:"IOWA", pick:"Illinois", confidence:68, riskLevel:"LEAN",
        headline:"FINAL: Illinois 71-59. Iowa's Cinderella run ends. Illini to first F4 since 2005.",
        result: { score1:71, score2:59, winner:"Illinois", correct:true, postGame:"Illinois took control down the stretch after Iowa briefly led 49-48 on a Stirtz basket. The Illini went on an 8-0 run to pull away. Only hit 3 threes all game but dominated inside and at the line. Iowa hung tough but Illinois' talent was too much. Brad Underwood emotional postgame — first F4 since the Deron Williams/Dee Brown era in 2005. Illinois faces Arizona in the Final Four." },
        market: { spread:"Illinois -6.5", ou:"138.5", ml1:"-290", ml2:"+235", take:"Illinois dominated Houston's defense — that's a team that was averaging 75+ PPG. Iowa's Cinderella run has been incredible but they shot 50%+ in back-to-back games which is unsustainable. Illinois won the regular season meeting 75-69 in Iowa City. Talent gap is real.", angle:"ILLINOIS -6.5 — Iowa is due for shooting regression. Illinois' defense travels." },
        edge: { offense: 92, defense: 75, experience: 72, health: 90 },
        edgeOpp: { offense: 68, defense: 60, experience: 65, health: 85 },
        keyStats: [{ label: "ILL Def", value: "Held Houston to 34% FG", hot: true },{ label: "Reg season", value: "Illinois won 75-69 at Iowa", hot: true },{ label: "Iowa bench", value: "38 pts vs NEB (unsustainable?)", hot: true }],
        injuries: [],
        whyPick:"Illinois held Houston — the #2 seed playing essentially at home — to 0.90 PPP and 34% shooting. That's elite defense from a team with the #1 KenPom offense ever. They already beat Iowa 75-69 in the regular season at Iowa City. Stojakovic, Ivisic, Wagler, Mirkovic — four legitimate 20-point scorers. Iowa's back-to-back 50%+ FG shooting games are due for regression.",
        whyNot:"Iowa controls tempo better than any team left. They slow games to 55 possessions which neutralizes Illinois' offensive advantage. Stirtz has hit go-ahead shots in three straight games. Folgueiras and Sage off the bench have been the best bench duo in the tournament. McCollum is out-coaching everyone. And Illinois' defense was shaky before the Houston game — one great defensive night doesn't make it a trend." },
      ],
  },
  MIDWEST: {
    R32: [
    ...
    E8: [
      { id:"ME", date:"Sun Mar 29", time:"2:15 PM ET", site:"United Center, Chicago", s1:1, t1:"Michigan", t1Short:"MICH", s2:6, t2:"Tennessee", t2Short:"TENN", pick:"Michigan", confidence:72, riskLevel:"LEAN",
        headline:"FINAL: Michigan 95-62. DEMOLITION. Lendeborg dominant again. Tennessee had no answer.",
        result: { score1:95, score2:62, winner:"Michigan", correct:true, postGame:"Total destruction. Michigan won by 33 points — the most lopsided E8 game in years. Lendeborg dominated again. Tennessee's physicality that overwhelmed Iowa State was meaningless against Michigan's size AND skill. The Wolverines have won every tournament game by 13+ points. Michigan faces the Duke/UConn winner in the Final Four." },
        market: { spread:"Michigan -7.5", ou:"142.5", ml1:"-340", ml2:"+270", take:"Michigan is the clear favorite. Lendeborg is having a generational tournament. The Wolverines have won every game by 13+ points. Tennessee's physicality is real but they haven't faced an offense this balanced. Michigan should cover.", angle:"MICHIGAN -7.5 — Tennessee's offense isn't good enough to keep pace. Lendeborg is unstoppable." },
        edge: { offense: 88, defense: 92, experience: 78, health: 78 },
        edgeOpp: { offense: 68, defense: 78, experience: 72, health: 88 },
        keyStats: [{ label: "Lendeborg", value: "23/12, near triple-double", hot: true },{ label: "MICH 3PT", value: "13-27 (48%) vs Alabama", hot: true },{ label: "TENN boards", value: "Outrebounded ISU 43-22", hot: true }],
        injuries: [{ player: "L.J. Cason", team: "Michigan", status: "OUT", impact: "MED", detail: "Torn ACL — but McKenney (17), Cadeau (17), Gayle (14) have all stepped up." }],
        whyPick:"Michigan has been the most consistent team in the tournament — won every game by 13+ points. Lendeborg is playing at a level nobody else can match (23/12 near triple-double vs Alabama). Four different double-digit scorers in every game. 13-27 from 3 against Alabama showed they can shoot from everywhere. Tennessee beat Iowa State because ISU had no Jefferson — Michigan has no such weakness.",
        whyNot:"Tennessee outrebounded Iowa State 43-22 — that wasn't a fluke, it's their identity. If they dominate Michigan's glass the same way, the game slows into a grind where Tennessee thrives. Ament and Boswell can score in bunches. Tennessee has been to three straight Elite Eights — they have experience Michigan doesn't. And Michigan's turnover rate (179th nationally) is still exploitable by a physical, aggressive team." },
      ],
  },
  FINAL_FOUR: [
