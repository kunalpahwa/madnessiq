...
const LATER_ROUNDS = {
  EAST: {
    ...
    S16: [
      ...
      { date:"Thu Mar 26", s1:3, t1:"Michigan St.", t1Short:"MSU", s2:2, t2:"UConn", t2Short:"UCONN", pick:"Michigan St.", confidence:52, originalConfidence:54, riskLevel:"TOSS-UP",
        headline:"🚨 Fears' 16 assists + Carr's dunks vs Reed's 31/27. Elite matchup.",
        whyPick:"Fears just had 12 pts and 16 ASSISTS against Louisville — he makes everyone better. Carr's athleticism (21 pts, highlight dunks) gives UConn a matchup problem they haven't seen. MSU's rebounding advantage negates UConn's Reed inside. UConn shot 5-25 from 3 in R64 — if that continues, MSU's physicality wins.",
        whyNot:"Reed's 31/27 was one of the best individual tournament performances in decades. Karaban added 22. When UConn's size advantage takes over, they're impossible to stop inside. Hurley's adjustments are elite and this UConn team has championship DNA.",
    ...
    E8: [
      { id:"EE", date:"Sat Mar 28", s1:1, t1:"Duke", t1Short:"DUKE", s2:3, t2:"Michigan St.", t2Short:"MSU", pick:"Duke", confidence:60, originalConfidence:64, riskLevel:"LEAN",
        headline:"Fears' 16-assist game makes MSU scarier. Boozer's talent vs Izzo's system.", whyPick:"Boozer is still the best player on the floor. But Duke's 2-15 3PT night vs Siena is a real concern against MSU's physicality. If Duke can't shoot, this becomes MSU's game. Duke's talent advantage in crunch time is the tiebreaker.", whyNot:"Fears just had 16 assists — the best playmaking performance in the tournament. Carr's athleticism (21 pts R32) gives Duke a matchup problem. MSU is peaking at exactly the right time. Izzo has eliminated 1-seeds before.",
  ...
  WEST: {
    ...
    S16: [
      ...
      { id:"WS1", date:"Fri Mar 27", s1:3, t1:"Gonzaga", t1Short:"ZAGA", s2:2, t2:"Purdue", t2Short:"PUR", pick:"Purdue", confidence:58, riskLevel:"TOSS-UP",
    ...
    E8: [
      { id:"WE", date:"Sun Mar 29", s1:1, t1:"Arizona", t1Short:"ARIZ", s2:2, t2:"Purdue", t2Short:"PUR", pick:"Arizona", confidence:62, riskLevel:"LEAN",
  ...
  MIDWEST: {
    ...
    S16: [
      { id:"MS0", date:"Thu Mar 26", s1:1, t1:"Michigan", t1Short:"MICH", s2:5, t2:"Texas Tech", t2Short:"TTU", pick:"Michigan", confidence:76, originalConfidence:74, riskLevel:"LEAN",
        headline:"Michigan just had its best game in months. 95-72, shot 56%/48% from 3. Mara locked down Avila.",
        edge: { offense: 88, defense: 98, experience: 78, health: 78 },
        edgeOpp: { offense: 78, defense: 62, experience: 70, health: 85 },
        keyStats: [
          { label: "MICH R32", value: "95-72, 56% FG, 48% 3PT", hot: true },
          { label: "Lendeborg R32", value: "25 pts, poster dunk", hot: true },
          { label: "Mara R32", value: "16 pts, 4 blk — held Avila to 9", hot: false },
        ],
        injuries: [
          { player: "L.J. Cason", team: "Michigan", status: "OUT", impact: "MED", detail: "Torn ACL — but 5 starters all scored in double figures without him." },
        ],
        whyPick:"Michigan just had their most complete game of the season — 56% from the field, 48% from 3, all five starters in double figures. Mara held Avila (one of the best shooters in the country) to 3-13. That defensive intensity will smother Texas Tech's perimeter shooters. Lendeborg is playing like a First-Team All-American.",
        whyNot:"Texas Tech shot 64% in R64 and has nothing to lose. If Petty gets hot again and Michigan's turnovers (179th nationally) show up, Tech can keep it close. But Michigan looks like the best team in the field right now." },
    ...
    E8: [
      { id:"ME", date:"Sat Mar 28", s1:1, t1:"Michigan", t1Short:"MICH", s2:2, t2:"Iowa State", t2Short:"ISU", pick:"Michigan", confidence:65, originalConfidence:54, riskLevel:"LEAN",
        headline:"Michigan looks like the best team in the field. 95-72 R32. But ISU's press is the test.", whyPick:"Michigan just had back-to-back dominant wins — 101-80 and 95-72 — with all five starters scoring double figures both games. Mara shut down the best 3PT shooting center in the country. Lendeborg is playing at First-Team All-American level. Size advantage is massive if ISU doesn't have Jefferson.", whyNot:"Iowa State's turnover-forcing defense is Michigan's kryptonite (179th in TO rate). If the Cyclones create 18+ turnovers, they win. Jefferson's status is the X factor — if he's back, this flips.",
        edge: { offense: 88, defense: 98, experience: 78, health: 78 },
